...
import uvicorn
from services.asr.post_process import verify_key,diarized,formated, model_manager,CACHE_DIR,MAX_FILE_MB,SAMPLE_RATE,MIN_DURATION_S,session_store,logger,ALLOWED_ORIGINS,limiter,lifespan,ALLOWED_TYPES
load_dotenv()
